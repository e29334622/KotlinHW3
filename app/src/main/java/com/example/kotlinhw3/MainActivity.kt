    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            AlertDialog.Builder(this)
                    ...
                    .setNeutralButton("取消") {dialog,which -> Toast.makeText(this,"取消",Toast.LENGTH_SHORT).show()
                    }
                    .setNegativeButton("自定義Toast") { dialog,which -> Toast.makeText(this,"自定義Toast",Toast.LENGTH_SHORT).show()
                    ...
                    .setPositiveButton("顯示list") {
                        ...
                        AlertDialog.Builder(this)
                            .setTitle("使用list呈現")
                            .setItems(list){
                                dialogInterface, i -> Toast.makeText(this,"你選擇的是"+list[i],Toast.LENGTH_SHORT).show()
                            }.show()
                    }.show()
